      ...
      <div className="flex justify-between items-center gap-x-2 gap-y-8 lg:flex-row flex-col">
        <div className={`lg:basis-3/5 flex flex-col gap-3 md:basis-auto`}>
          ...
          >
            ...
            <AppText
              ...
              bold
              primary
            >{`VEMANA ANIL KUMAR`}</AppText>
            <div className="flex flex-row flex-wrap gap-2">
              <AppText textTag="p" extraMedium semiBold defaultColor>
                {`I'm a`}
              </AppText>
              <TypingText textArr={["Data Scientist", "Machine Learning Engineer", "Artificial Intelligence Engineer", "Cloud Engineer"]} />
            </div>
            <AppText textTag="p" medium defaultColor customClass="mt-4 mb-4">
              {`I'm a part-time tech geek and a full-time dreamer of ethical AI. With AI evolving rapidly, I'm passionate about driving responsible innovation in Artificial Intelligence, Machine Learning, and Cloud Computing.`}
            </AppText>
            <ContactLogos />
          </div>
          <div className="flex items-center justify-start gap-4 mt-6 flex-wrap">
            ...
            buttonType="primary"
            onClick={() => window.location.href = 'tel:+16177779138'}
            ...
            <AppButton
              ...
              onClick={() => {
                window.open("https://drive.google.com/file/d/1pezO4LlidOKDxUzk3QVlpW_VEm3Ao_Ft/view?usp=sharing", '_blank');
              }}
        ...
        <div className="lg:basis-2/5 md:basis-auto">
          <div className="md:w-[300px] md:h-[350px] sm:h-[75vw] sm:w-[40vw] h-[120vw] w-[50vw] relative m-auto">
            <Image
              alt="VEMANA ANIL KUMAR"
              src={"/images/veman.png"}
              fill
              loading={"lazy"}
